...
public class GetoptTest extends TestCase {
    ...
    public GetoptTest(String testName) {
        super(testName);
        getopt = new Getopt();
        getopt.addOption(new Getopt.CommandLineOption('a', "--alpha", true)).
                addOption(new Getopt.CommandLineOption('b', "--bravo", false)).
                addOption(new Getopt.CommandLineOption('c', "--charlie", false));
    }
    ...
    public void testParseSingleLongOptionWithoutArgument() {
        String[] argv = {"--bravo"};
        List<Getopt.Entry> options = getopt.parse(argv);
